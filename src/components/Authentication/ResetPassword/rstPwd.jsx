    ...
    return <>
        <div className="authDiv">
            <div className="leftDiv">
                ...
                <p className="wrongEmail">Password must be minimum eight characters, at least one uppercase letter, one lowercase letter, one number and one special character</p>
                ...
                <p className="wrongEmail">Password entered in two fields must be same.</p>
